...
ここでは、カードを受け取った方が [ギフト受取ページ](/receive) を使ってギフトを受け取る方法について説明します。
...
- カードに書かれている8桁の数字（PINコード）を入力し、「ギフトを見る」ボタンを押してください。

![PINコード入力画面](/images/manual/p-ギフトの受け取り方-パスコードの入力.png)
...
※ もし入力情報を誤った場合は、ショップに直接ご連絡ください。

![配送先情報の入力画面](/images/manual/p-ギフトの受け取り方-配送先情報の入力.png)
...
※ もし発送処理に関して不明点等を問い合わせたい場合は、「？お問い合わせ」ボタンからギフトの詳細情報を確認し、配送処理を対応しているショップに対して直接お問い合わせください。
