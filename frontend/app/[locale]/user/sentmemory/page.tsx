            ...
            <Card className="w-full max-w-2xl shadow-xl border-none bg-white/80 backdrop-blur-md rounded-3xl overflow-hidden">
                <CardHeader className="bg-gradient-to-r from-green-500 to-emerald-600 p-8 text-white flex flex-col gap-4">
                    ...
                    <div className="flex flex-row items-center gap-4">
                        ...
                        <div>
                            <CardTitle className="text-2xl font-black tracking-tight">{t('sendList')}</CardTitle>
                            <p className="text-green-100/80 text-sm mt-1">{t('sendListDesc')}</p>
                        </div>
                    </div>
                </CardHeader>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="flex items-center gap-1.5 mb-1 group">
                                            ...
                                            <Button
                                                variant="ghost"
                                                size="icon"
                                                className="h-4 w-4 text-gray-300 hover:text-gray-600"
