...
import { Loader2, Send, ChevronDown, ExternalLink, Copy, Check, LayoutGrid, Layers } from "lucide-react";
                    ...
                    <div className="flex flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex bg-black/20 p-1 rounded-xl backdrop-blur-md border border-white/10">
                            <button
                                ...
                                className={`p-2 rounded-lg transition-all ${viewMode === 'grid' ? 'bg-white text-emerald-600 shadow-lg' : 'text-white/60 hover:text-white'}`}
                                title="Grid View"
                            >
                            ...
                            <button
                                ...
                                className={`p-2 rounded-lg transition-all ${viewMode === 'stack' ? 'bg-white text-emerald-600 shadow-lg' : 'text-white/60 hover:text-white'}`}
                                title="Stack View"
                            >
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        >
                                            ...
                                            >
                                                <Card className="w-full h-full p-0 border-b-[3px] border-gray-400 border-b-emerald-800 bg-slate-100 rounded-2xl overflow-hidden border-x border-t shadow-xl ">
                                            ...
                                            >
                                                <Card className="w-full h-full p-0 border-b-[3px] border-b-emerald-700 border-emerald-900 bg-emerald-950 rounded-2xl shadow-2xl overflow-hidden">
                                                    <CardContent className="p-6 h-full flex flex-col text-white border-2 border-white/10 rounded-2xl">
                                                        {/* Top Section */}
                                                        <div className="pointer-events-none">
                                                            {item.shop_name ? (
                                                                <p className="text-[9px] text-green-300 text-center font-black uppercase tracking-[0.2em] leading-none">{item.shop_name}</p>
                                                            ) : (
                                                                <div className="h-[9px]" />
                                                            )}
                                                        </div>
                                                        ...
                                                        <div className="flex-1 flex items-center justify-center py-2">
                                                            {item.pin && (
                                                                <div className="w-full relative flex items-center justify-center p-3 rounded-xl bg-green-500/10 border border-green-500/20 hover:bg-green-500/20 transition-all min-h-[80px]">
                                                                    <div className="flex flex-col items-center pointer-events-none">
                                                                        <span className="text-[15px] font-black text-green-300/40 uppercase tracking-widest leading-none mb-1">PIN</span>
                                                                    ...
                                                                    <div className="absolute right-3">
                                                                        <Button
                                                                            variant="ghost"
                                                                            size="icon"
                                                                            className="h-10 w-10 text-green-300/50 hover:text-white hover:bg-white/10 rounded-lg shrink-0"
                                                        ...
                                                        <div className="flex flex-col items-center gap-3">
                                                            <Button
                                                                className="rounded-xl bg-emerald-600 hover:bg-emerald-500 text-white font-black text-[20px] uppercase tracking-[0.1em] shadow-xl gap-2 group/btn shrink-0 p-3"
